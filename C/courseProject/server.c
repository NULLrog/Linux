/*Курсовой проект. Два типа клиентов совершают совместную работу.
* Первый тип клиентов записывает в разделяемую память сообщения
* количеством до 10 штук, а Второй тип клиентов произовдит чтение
* этих сообщений. Чтение и запись сообщений производится по протоколу
* TCP, отправка служебных сообщений об отсутствии сообщений или наличии
* осуществляется по протоколу UDP*/
#include <stdio.h>
#include <stdlib.h>
#include <unistd.h>
#include <string.h>
