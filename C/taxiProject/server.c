                        ...
                        if(taxis->clid != -1) {
                            if((clients = search_c_id(clients, taxis->clid))) {
                                ...
                                if(TAXICOUNT) {
                                    ...
                                    cli.y2 = clients->y2; 
                                    Taxi *taxis2 = taxis;
                                    int answer = distance(taxis2, cli);
                                    if(answer == EXCEPTION) {
                                        clients->taxid = -1;
                                        clients->status = WAIT;
                                        clients = clihead;
                                    ...
                                    printf("Selected %d taxi\n", answer);
                                    taxis2 = head;
                                    clients = search_c_id(clients, cli.id);
                                    taxis2 = search_t(taxis, answer);
                                    clients->taxid = answer;
                                    taxis2->clid = clients->id;
                                    clients->status = WAIT;
                                    send_stat(clients->sock, clients->status, clients->taxid);
                                    race(taxis2, clients);
                                    clients = clihead;
